...
@section('title', 'Manage Offer Stock')
@section('content')
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Offer Stock  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Offer Stock  </h5>
                </header>
                                                    ...
                                                    @if(isset($value->OfferProducts->product_title))
                                                        <a href="{{ route('view_product', ['id' => $value->product_id]) }}">
                                                            ...
                                                            @if($value->att_name && $value->att_value) 
                                                                @if($value->AttributeName->att_name && $value->AttributeValue->att_value)
                                                                    ({{$value->AttributeName->att_name}} : {{$value->AttributeValue->att_value}})
                                                                @endif
                                                            @endif 
                                                        </a>
                                                    @else
    ...
    <script type="text/javascript">
        $('#export_csv').on('click',function(){
            ...
            if (all.length === 0) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{url('/export_offer_stock_csv')}}',
