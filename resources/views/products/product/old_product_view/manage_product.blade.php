                                    ...
                                    @foreach($product as $key => $value)
                                        <tr>
                                            ...
                                            <td class="gj_p_actions">
                                                <span>
                                                    <a href="/edit_product/{{$value->id}}" data-tooltip="Edit">
                                                        <i class="fa fa-edit fa-2x"></i>
                                                    </a>
                                                </span>
                                                <span>
                                                    <a href="/status_product/{{$value->id}}" data-tooltip="block">
                                                        @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="/view_product/{{$value->id}}" id="{{$value->id}}" class="gj_mge_product_vw" data-tooltip="View">
