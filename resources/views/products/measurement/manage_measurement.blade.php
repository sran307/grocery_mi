...
@section('title', 'Manage Measurement Units')
@section('content')
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Measurement Units  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Measurement Units  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_measurement">
                        <table class="table table-bordered table-striped" id="gj_mge_measurement_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                            ...
                            <tbody id="gj_mge_measurement_bdy">
                                @if($measurement)
                                    @php ($i = 1)
                                    ...
                                    @foreach($measurement as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_measurement', ['id' => $value->id]) }}" data-tooltip="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_measurement', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_measurement_del" data-tooltip="Delete">
...
<script>
    $(document).ready(function() { 
        $('#gj_mge_measurement_table').dataTable({
            "paginate": true,
            "searching": true,
            "bInfo" : false,
            "sort": true
            ...
            $.confirm({
                ...
                buttons: {
                    Ok: function(){
                        $.ajax({
                            type: 'post',
                            url: '{{url('/delete_measurement_all')}}',
                            data: {ids: all, type: 'unblock'},
                            success: function(data){
                                if(data == 0){
                                    window.location.reload();
    ...
    $('.gj_mge_measurement_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
