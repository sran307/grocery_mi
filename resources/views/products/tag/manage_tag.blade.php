        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Tag  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Tag  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_tag">
                        <table class="table table-bordered table-striped" id="gj_mge_tag_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($tag)
                                    ...
                                    @foreach($tag as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_tag', ['id' => $value->id]) }}" data-tooltip="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_tag', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_tag_del" data-tooltip="Delete">
...
<script>
    ...
    $('.gj_mge_tag_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
