                                              ...
                                              <table class="table table-stripped table-bordered">
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td class="gj_cp">₹ {{$value->product_cost}}</td>
                                ...
                                <div class="col-xl-2 col-md-4 col-sm-12 col-12 ft-2">
                                  <div class="collapsed-block footer-block">
                                      ...
                                      <ul class="footer-block-content">
                                          ...
                                          <li>
                                            <a target="_blank" href="{{ route('home') }}/site_map.xml">Site Map</a>
                                          </li>
                                      </ul>
                                  </div>
                                </div>
                                ...
                                <div class="col-xl-2 col-md-4 col-sm-12 col-12 ft-3">
                                  <div class="collapsed-block footer-block">
                                      ...
                                      <div class="footer-block-content footer-newsletter">
                                          <p>We’ll never share your email address with Ecambiar</p>
