...
@section('title', 'Manage Feed Back')
@section('content')
<section class="gj_bk_feeds_setting">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Feed Back  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Feed Back  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_feeds">
                        <table class="table table-bordered table-striped" id="gj_mge_feeds_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($feeds)
                                    ...
                                    @foreach($feeds as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value->subject}}</td>
                                            <td>
                                                <a href="{{ route('status_feedbacks', ['id' => $value->id]) }}" title="block/unblock">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <span>
                                                    <a href="{{ route('view_feedbacks', ['id' => $value->id]) }}" title="View">
                                                        <i class="fa fa-eye fa-2x"></i>
                                                    </a>
                                                </span>
                                                <span>
                                                    <a href="#" id="{{$value->id}}" class="gj_mge_feeds_del" data-tooltip="Delete">
...
<script>
    ...
    $('.gj_mge_feeds_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
