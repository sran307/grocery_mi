...
@endif
<section class="gj_buss_signup_bk">
        ...
        <div class="container">
            <div class="login-signup">
                <div class="row">
                    ...
                    <div class="col-sm-8 nav-tab-holder">
                        <ul class="  navees row" role="tablist">
                            <li role="presentation" class="buusrs"><a href="#profile" class="active show tabiz" aria-controls="profile" role="tab" data-toggle="tab"> Business User</a></li>
                        </ul>
                    </div>
                    <div class="col-2 col-md-2">
                    </div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane tabiz active" id="profile">
                        <div class="row">
                            <div class="col-2 col-md-2">
                            </div>
                            <div class="col-12 col-md-8">
                                <div class="formaccount formlogin">
                                    {{ Form::open(array('url' => 'sell_on_ecambiar','class'=>'gj_merchant_form buzzacc','files' => true)) }}
                                        ...
                                        <div class="col-md-6">
                                             ...
                                             <h5 class="gj_heading"> Business Details </h5>
                                            ...
                                            <div class="form-group">
                                                {{ Form::label('is_gst', 'GST Registered ?') }}
                                                <span class="error">* 
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{ Form::number('phone2', Input::old('phone2'), array('class' => 'form-control gj_phone2','placeholder' => 'Enter Merchant Alternate Phone Number')) }}
                                            </div>
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                {{ Form::text('commission', Input::old('commission'), array('class' => 'form-control gj_commission','placeholder' => 'Enter Merchant Commission')) }}
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{ Form::text('return_commission', Input::old('return_commission'), array('class' => 'form-control gj_return_commission','placeholder' => 'Enter Merchant Return Commission')) }}
                                            </div> -->
                                            ...
                                            <div class="form-group">
                                                {{ Form::label('document', 'Upload Documents') }}

                                                <p class="gj_note error">* Upload the Document File Format only pdf, docx, jpg, png</p>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_keyword" id="meta_keyword" class="form-control gj_meta_keyword" placeholder="Enter Meta Keyword in English" rows="6">{{Input::old('meta_keyword')}}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" id="meta_description" class="form-control gj_meta_description" placeholder="Enter Meta Description in English" rows="11">{{Input::old('meta_description')}}</textarea>
                                            </div>
                                        ...
                                        <p class="text-center cr_acc pull-right">
