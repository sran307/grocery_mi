...
<script>
    ...
    function cut_off(sum, shc, sc, tax_tot, cnt_shc) {
        ...
        var tot = 0.00;
var cart_ids = $("input[name='det_order_id[]']")
              .map(function(){return $(this).val();}).get();
        $.ajax({
            type: 'post',
            url: '{{url('/check_cut_off')}}',
            data: {sum: sum, tax_tot: tax_tot, cnt_shc: cnt_shc,btn:1, shc: shc, sc: sc, is_cod: is_cod,cart_ids:cart_ids, type: 'check_cut_off'},    
            dataType:"json",   
