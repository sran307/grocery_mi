...
@section('title', 'Create Grv Orders')
@section('content')
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Create Grv Orders  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Create Grv Orders  </h5>
                </header>

                <div class="col-md-12">
                    @if($orders)
                        {{ Form::open(array('url' => 'create_grv_orders','class'=>'gj_cre_grv_form','files' => true)) }}
                            ...
                            <div class="form-group">
                                {{ Form::label('grv_remarks', 'Remarks') }}
                                <span class="error">* 
                                ...
                                {{ Form::textarea('grv_remarks', Input::old('grv_remarks'), array('class' => 'form-control gj_grv_remarks','placeholder' => 'Enter Remarks','rows' => '5')) }}
                            </div>
                        ...
                        {{ Form::close() }}
                    @else
                        <p class="gj_nodata">GRV Created Not Possible!</p>
