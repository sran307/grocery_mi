...
@section('title', 'Create Credit Notes')
@section('content')
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Create Credit Notes  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Create Credit Notes  </h5>
                </header>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="gj_py_ro_div">
                                    ...
                                    <span class="gj_py_ro">
                                        <input type="radio" name="return_type" value="Refund" checked> Refund
                                    </span>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('body').on('change','.det_return_qty',function() {
        ...
        if(qty == 0) {
            ...
            setTimeout(function(){ window.location.href = "<?php echo route('create_credit_notes'); ?>"; }, 3000);
        } else if(r_qty < qty) {
            var qty = 1;
            $(this).val(qty);
            $.confirm({
