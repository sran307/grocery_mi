        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Enqueries  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Enqueries  </h5>
                </header>
                                ...
                                @if($enquiries)
                                    ...
                                    @foreach($enquiries as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('view_enquiries', ['id' => $value->id]) }}" data-tooltip="block">
                                                    <i class="gj_view fa fa-eye fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_enquiries_del" data-tooltip="Delete">
