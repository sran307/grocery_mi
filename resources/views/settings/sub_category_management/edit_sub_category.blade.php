    ...
    <div class="row gj_row">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <div class="col-md-12">
                    {{ Form::open(array('url' => 'edit_sub_category','class'=>'gj_geneal_form','files' => true)) }}
                        @if($sub_cats)
                            {{ Form::hidden('msc_id', $sub_cats->sub_cat_id, array('class' => 'form-control gj_b_id')) }}
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('h_main_cat_name', ($sub_cats->cat_name ? $sub_cats->cat_name : Input::old('main_cat_name')), array('class' => 'form-control gj_h_main_cat_name', 'disabled' ,'placeholder' => 'Enter Category Name In English')) }}
                            {{ Form::hidden('main_cat_name', ($sub_cats->main_cat_name ? $sub_cats->main_cat_name : 0), array('class' => 'form-control gj_main_cat_name','placeholder' => 'Enter Category Name In English')) }}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('sub_cat_name', ($sub_cats->sub_cat_name ? $sub_cats->sub_cat_name : Input::old('sub_cat_name')), array('class' => 'form-control gj_sub_cat_name','placeholder' => 'Enter Sub Category Name In English')) }}
                        </div>
                        ...
                        <div class="gj_ban_img_whole">
                            ...
                            @if(isset($sub_cats))
                                ...
                                <div class="form-group">
                                    {{ Form::label('current_sub_cat_image', 'Current Sub Category Image') }}
                                    <div class="gj_mc_div">
                                       <img src="{{ asset($file_path.'/'.$sub_cats->sub_cat_image)}}" class="img-responsive"> 
                                    </div>
                                    {{ Form::hidden('old_sub_cat_image', ($sub_cats->sub_cat_image ? $sub_cats->sub_cat_image : ''), array('class' => 'form-control')) }}
                                </div>
                                @endif
                            @endif
