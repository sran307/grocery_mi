        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Side Image  </a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Side Banner Image  </h5>
                </header>
                                ...
                                @if($banner)
                                    ...
                                    @foreach($banner as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_side_banner_image', ['id' => $value->id]) }}" data-tooltip="Edit">
        ...
        $.confirm({
            ...
            buttons: {
                Ok: function(){
                    $.ajax({
                        type: 'post',
                        url: '{{url('/delete_side_banner_image')}}',
