        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                <header>
                    ...
                    <h5 class="gj_heading"> Edit Banner Image  </h5>
                </header>

                <div class="col-md-12">
                    {{ Form::open(array('url' => 'edit_banner_image','class'=>'gj_geneal_form','files' => true)) }}
                        @if($banner)
                        ...
                        <div class="form-group">
                            {{ Form::label('slider_speed', 'Image Slider Speed') }}
                            <span class="error">* 
                            ...
                            {{ Form::number('slider_speed', ($banner->slider_speed ? $banner->slider_speed : Input::old('slider_speed')), array('class' => 'form-control gj_slider_speed','placeholder' => 'Banner Slider Speed in Number')) }}
