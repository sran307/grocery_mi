...
@section('title', 'Add CMS Disclaimers Page')
@section('content')
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Add CMS Disclaimers Page  </h5>
                </header>

                <div class="col-md-12">
                    {{ Form::open(array('url' => 'add_disclaimers','class'=>'gj_disc_cms_form','files' => true)) }}
                        @if(isset($discls))
                            @if($discls)
                                {{ Form::hidden('a_id', $discls->id, array('class' => 'form-control gj_a_id')) }}
                            @endif
                        @endif
...
<script>
    $(document).ready(function() { 
        ...
        <?php 
            if(isset($discls)) {
                if($discls->page_data) { 
                $ed = htmlentities($discls->page_data, ENT_QUOTES);
                $ed = preg_replace( "/\r|\n/", "", $ed); ?>
