...
@section('title', 'Manage Tax CutOff')
@section('content')
<section class="gj_cutoff_setting">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Tax CutOff  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Tax CutOff  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_cutoff">
                        <table class="table table-bordered table-striped" id="gj_mge_cutoff_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($cutoff)
                                    ...
                                    @foreach($cutoff as $key => $value)
                                        <tr>
                                            ...
                                            <td>Above Rs. {{$value->above_amount}}</td>
                                            <td>Rs. {{$value->shiping_amount}}</td>
                                            <td>{{$value->remarks}}</td>
                                            <td>
                                                <a href="{{ route('edit_cutoff', ['id' => $value->id]) }}" title="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_cutoff', ['id' => $value->id]) }}" title="Block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_cutoff_del" title="Delete">
...
<script>
    ...
    $('.gj_mge_cutoff_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
