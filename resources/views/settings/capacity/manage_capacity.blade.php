...
@section('title', 'Manage Capacity')
@section('content')
<section class="gj_capacity_setting">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage Capacity  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Capacity  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_capacity">
                        <table class="table table-bordered table-striped" id="gj_mge_capacity_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($capacity)
                                    ...
                                    @foreach($capacity as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_capacity', ['id' => $value->id]) }}" data-tooltip="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_capacity', ['id' => $value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_capacity_del" data-tooltip="Delete">
...
<script>
    $(document).ready(function() { 
        $('#gj_mge_capacity_table').dataTable({
            "paginate": true,
            "searching": true,
            "bInfo" : false,
            "sort": true
    ...
    $('.gj_mge_capacity_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
