        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Attributes  </h5>
                </header>
                                ...
                                @if($attributes)
                                    ...
                                    @foreach($attributes as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_attributes', ['id' => $value->id]) }}" data-tooltip="Edit">
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_attributes_del" data-tooltip="Delete">
