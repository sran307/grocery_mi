        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Attributes Fields  </h5>
                </header>
                                ...
                                @if($att_fields)
                                    ...
                                    @foreach($att_fields as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_att_fields', ['id' => $value->id]) }}" data-tooltip="Edit">
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_att_fields_del" data-tooltip="Delete">
