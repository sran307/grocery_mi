...
@section('title', 'Manage GST Tax')
@section('content')
<section class="gj_gsttax_setting">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            <!-- <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a> Manage GST Tax  </a></li>
                    </ul>
                </div>
            </div> -->
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage GST Tax  </h5>
                </header>
                ...
                <div class="col-md-12">
                    <div class="table-responsive gj_manage_tax">
                        <table class="table table-bordered table-striped" id="gj_mge_tax_table">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>#</th>
                                ...
                                @if($tax)
                                    ...
                                    @foreach($tax as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value->MainCat->main_cat_name}}</td>
                                            <td>{{$value->tax}} %</td>
                                            <td>
                                                <a href="{{ route('edit_tax', ['id' => $value->id]) }}" title="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_tax', ['id' => $value->id]) }}" title="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_tax_del" title="Delete">
...
<script>
    ...
    $('.gj_mge_tax_del').on('click',function(){
        var id = 0;
        if($(this).attr('id')) {
            id = $(this).attr('id');
        }
