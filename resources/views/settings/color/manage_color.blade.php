        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Colour  </h5>
                </header>
                                ...
                                @if($colour)
                                    ...
                                    @foreach($colour as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_color', ['id' => $value->id]) }}" data-tooltip="Edit">
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_colour_del" data-tooltip="Delete">
