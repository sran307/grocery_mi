        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Edit Color  </h5>
                </header>

                <div class="col-md-12">
                    {{ Form::open(array('url' => 'edit_color','class'=>'gj_color_form','files' => true)) }}

                    @if($colour)
                        {{ Form::hidden('colour_id', $colour->id, array('class' => 'form-control gj_colour_id')) }}
                    @endif
