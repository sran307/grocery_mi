        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="gj_box dark">
                ...
                <header>
                    ...
                    <h5 class="gj_heading"> Manage Package  </h5>
                </header>
                                ...
                                @if($dimensions)
                                    ...
                                    @foreach($dimensions as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value->title}}</td>
                                              <td>{{$value->type}}</td>
                                                <td> {{$value->height}}  X {{$value->length}} X {{$value->width}}</td>
                                            <td>
                                                <a href="{{ route('edit_package_dimension', ['id' => $value->id]) }}" data-tooltip="Edit">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ route('status_package', [$value->id]) }}" data-tooltip="block">
                                                    @if($value->is_block == 1)
                                            ...
                                            <td>
                                                <a href="#" id="{{$value->id}}" class="gj_mge_size_del" data-tooltip="Delete">
