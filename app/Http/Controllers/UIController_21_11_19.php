...
class UIController extends Controller
{
    ...
    public function AllFilterProducts (Request $request) {
        ...
        $all_products = array();
        if(($p_amount1) && ($p_amount2) && ($fil_cats) && ($fil_atts)) {
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::WhereIn('id', $p_id)->Where('is_block',1)->WhereBetween('discounted_price', [$p_amount1, $p_amount2])->Where('main_cat_name', $fil_cats);
                } else {
                    $all_products = Products::Where('is_block',1)->WhereBetween('discounted_price', [$p_amount1, $p_amount2])->Where('main_cat_name', $fil_cats);
                }
            } else {
                $all_products = Products::Where('is_block',1)->WhereBetween('discounted_price', [$p_amount1, $p_amount2])->Where('main_cat_name', $fil_cats);
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::WhereIn('id', $p_id)->Where('is_block',1)->WhereBetween('discounted_price', [$p_amount1, $p_amount2]);
                } else {
                    $all_products = Products::Where('is_block',1)->WhereBetween('discounted_price', [$p_amount1, $p_amount2]);
                }
            } else {
                $all_products = Products::Where('is_block',1)->WhereBetween('discounted_price', [$p_amount1, $p_amount2]);
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::WhereIn('id', $p_id)->Where('is_block',1)->Where('discounted_price', '>=', $p_amount1)->Where('main_cat_name', $fil_cats);
                } else {
                    $all_products = Products::Where('is_block',1)->Where('discounted_price', '>=', $p_amount1)->Where('main_cat_name', $fil_cats);
                }
            } else {
                $all_products = Products::Where('is_block',1)->Where('discounted_price', '>=', $p_amount1)->Where('main_cat_name', $fil_cats);
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::WhereIn('id', $p_id)->Where('is_block',1)->Where('discounted_price', '<=', $p_amount2)->Where('main_cat_name', $fil_cats);
                } else {
                    $all_products = Products::Where('is_block',1)->Where('discounted_price', '<=', $p_amount2)->Where('main_cat_name', $fil_cats);
                }
            } else {
                $all_products = Products::Where('is_block',1)->Where('discounted_price', '<=', $p_amount2)->Where('main_cat_name', $fil_cats);
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::Where('is_block',1)->Where('discounted_price', '>=', $p_amount1)->WhereIn('id', $p_id);
                } else {
                    $all_products = Products::Where('is_block',1)->Where('discounted_price', '>=', $p_amount1); 
                }
            } else {
                $all_products = Products::Where('is_block',1)->Where('discounted_price', '>=', $p_amount1); 
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::Where('is_block',1)->Where('discounted_price', '<=', $p_amount2)->WhereIn('id', $p_id); 
                } else {
                    $all_products = Products::Where('is_block',1)->Where('discounted_price', '<=', $p_amount2); 
                }
            } else {
                $all_products = Products::Where('is_block',1)->Where('discounted_price', '<=', $p_amount2);  
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::Where('is_block',1)->Where('main_cat_name', $fil_cats)->WhereIn('id', $p_id); 
                } else {
                    $all_products = Products::Where('is_block',1)->Where('main_cat_name', $fil_cats); 
                }
            } else {
                $all_products = Products::Where('is_block',1)->Where('main_cat_name', $fil_cats);  
            }
            ...
            if(isset($att) && count($att) != 0) {
                ...
                if(count($p_id) != 0){
                    $all_products = Products::Where('is_block',1)->WhereIn('id', $p_id); 
                }
            }
        } elseif (($p_amount1)) {
            $all_products = Products::Where('is_block',1)->Where('discounted_price', '>=', $p_amount1); 
        ...
        if(count($all_products) != 0) {
            return View::make("front_end.all_products")->with(array('all_products'=>$all_products, 'category'=>$category, 'featured_products'=>$featured_products, 'attributes'=>$attributes, 'widget'=>$widget, 'filter_cats'=>$fil_cats, 'filter_atts'=>$fil_atts, 'filter_amount1'=>$p_amount1, 'filter_amount2'=>$p_amount2, 'filter_sort'=>$sort_by));
        } else {
            Session::flash('message', 'No More Products by your Searched Items!'); 
            Session::flash('alert-class', 'alert-danger');
            return redirect()->route('all_products');
