...
class ApiController extends Controller
{
 ...
 //otp generation start
                            ...
                            if($order->save()) {
                                ...
                                if($payment_method == 1) {
                                    ...
                                    if($email!='null'){
                                        ...
                                        $body = '<div class="gj_mail" style="width: 600px; padding: 20px 30px; margin: 0 auto; position: relative; background-image: url('.asset('images/shadow.png').'); background-repeat: no-repeat;  background-size: 100% 102%;">
                                    ...
                                    /*<tr>
                                                    ...
                                                    $pdf_html.='<div class="container">
                                                    <div class="clops" style="">
                                                    <h3 class="h1" align="center" style="color:black">INVOICE</h3>
                                                            <img src="'.asset('images/genral/').'" width="50px" height="50px">
                                                        </div>';
                                                    $pdf_html.=' <table class="table table-striped" width="100%" style="border-collapse: collapse; border: 0px;">
                                                                <thead>
                                                                    <tr>
                                                     ...
                                                     $pdf_html.='<p><b>customer name</b></p>
                                                      <p><i class="fa fa-envelope-o" aria-hidden="true"></i>customer email</p>';
                                                    
                                                        $pdf_html.='<p><i class="fa fa-phone"></i>user phone</p>';
                                            
                                            
                                                    $pdf_html.='</td>
                                                    <td>
                                                      <p><b>address</b></p>
                                                      <p class="font-weight">full address</p>';
                                                    
                                                      $pdf_html.='<p class="font-weight">country state city</p>
                                                      <p class="font-weight">pimcode</p>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                                    </table>';
                                                    ...
                                                    $pdf_html.='<table class="table table-striped" width="100%" style="border-collapse: collapse; border: 0px;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <p><b>Total Qty:quantity</b></p>
                                                                    
                                                                    <p><b>Order Total: <i class=""></i>total </b></p>
                                                                    <p><b>Payment Recieved:</b>payment status</p>
                                                                </td>
                                            
                                                                <td>
                                                                    <p><b>Payment Method: </b>payment method</p>
                                                                    <p><b>TXN ID:</b> <b><i>Transaction id</i></b></p>
                                                  ...
                                                  $pdf_html.=' <table class="table table-striped table-bordered" width="100%" style="border-collapse: collapse; border: 0px;">
                                                        <thead>
                                                            <tr>
                                                                <th>Invoice No</th>
                                                                <th>Item Image</th>
    ...
    {
       $device_id='fShrTuXkSLK6ogcoFN9KOQ:APA91bGoqqztMc506V6RjgvjKeBnpkCMzFjFLC4TdTmT2DK_MNoTvmzXNFkOFH6MdYfSAJAh0o7_YQXsOEao0XXrFE9yp9oPTbHyNIiBsPmJrW2kcZVZxtZwS_djsFWwboeTBtgmqIGj';
        $message="for check";
        $data=['hy', 'hello'];
    ...
    public function get_pdf()
    {
      ...
      $pdf_html.=' <table class="table table-striped table-bordered" width="100%" style="border-collapse: collapse; border: 0px;">
       ...
       $from        = "Grocery360<order@grocery360.in>"; // address message is sent from
