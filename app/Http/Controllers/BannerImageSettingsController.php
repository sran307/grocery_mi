...
class BannerImageSettingsController extends Controller
{
    ...
    public function manage_side_banner_image()
    {
        ...
        if($loged) {
            ...
            if($privil) {
                $page = "Settings";
                $banner = BannerSideImage::all();

            	return View::make("settings.banner_image.manage_side_banner_image")->with(array('banner'=>$banner,'page'=>$page));
            } else {
                Session::flash('message', 'You Are Not Access This Module!'); 
                Session::flash('alert-class', 'alert-danger');
                return redirect()->back();
    ...
    public function add_side_banner_image()
    {
        $loged = session()->get('user');
        if($loged) {
            $privil = DB::table('previlages as A')
            ...
            if($privil) {
            	$page = "Settings";
            	return View::make('settings.banner_image.add_side_banner_image')->with(array('page'=>$page));
            } else {
                Session::flash('message', 'You Are Not Access This Module!'); 
                Session::flash('alert-class', 'alert-danger');
                return redirect()->back();
...
public function add_side_banner_image_store(Request $request)
{
        ...
        if($loged) {
            ...
            if($privil) {
                ...
                if ($validator->fails()) {
            	   	return View::make('settings.banner_image.add_side_banner_image')->withErrors($validator);
                } else {
                    $data = Input::all();
                    
                	$banner = new BannerSideImage();
                    ...
                    if($banner) {
        	            ...
        	            if($banner->save()) {
        					...
        					return redirect()->route('manage_side_banner_image');
        	            } else{
        ...
        if($loged) {
            ...
            if($privil) {
                ...
                if ($validator->fails()) {
                    ...
                    if($banner) {
        	            $banner->image_title    = $data['image_title'];	            
                        $banner->slider_speed   = $data['slider_speed'];             
    ...
    public function edit_side_banner_image($id)
    {
        ...
        if($loged) {
            ...
            if($privil) {
        		$page = "Settings";
        		$banner = BannerSideImage::where('id',$id)->first();
        		if($banner) {
        			return View::make("settings.banner_image.edit_side_banner_image")->with(array('banner'=>$banner,'page'=>$page));
        		} else {
...
public function edit_side_banner_image_store(Request $request)
{
	...
	public function delete_side_banner_image(Request $request)
	{
